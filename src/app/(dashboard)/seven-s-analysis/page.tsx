...
export default function SevenSAnalysisPage() {
  ...
  const onSubmit = async (values: z.infer<typeof sevenSFormSchema>) => {
    setIsLoading(true);
    ...
    <TooltipProvider>
      <div className="container mx-auto grid grid-cols-1 gap-12 px-4 py-8 lg:grid-cols-5">
        <div className="lg:col-span-2">
            <Card className="mt-4">
                <CardHeader>
                <CardTitle>7-S Analysis Input</CardTitle>
                <CardDescription>
                    Select an industry template or fill the inputs manually.
                </CardDescription>
                </CardHeader>
                <CardContent>
            ...
            <Form {...sevenSForm}>
                <form onSubmit={sevenSForm.handleSubmit(onSubmit)} className="mt-8 space-y-4">
        ...
        <aside className="lg:col-span-3">
            ...
            <CardHeader>
                <CardTitle className="font-headline text-2xl">Your 7-S Blueprint</CardTitle>
                <CardDescription>
                AI-generated insights for your 7-S analysis.
                </CardDescription>
            </CardHeader>
            <CardContent className="min-h-[600px]">
                ...
                <div className="flex h-full min-h-[400px] flex-col items-center justify-center rounded-md border-2 border-dashed bg-muted/50 p-8 text-center">
                    ...
                    Your personalized 7-S blueprint will appear here. Fill out the form on the left to get started.
                    </p>
                </div>
                )}
            </CardContent>
